                                ...
                                @foreach($contacts as $contact)
                                    <tr class="hover:bg-blue-50 transition-colors duration-150">
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">#{{ $contact->id }}</span>
                                        </td>
                                        ...
                                        @auth
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium flex space-x-2">
                                                <a href="{{ route('contacts.show', $contact->id) }}" class="text-blue-600 hover:text-white hover:bg-blue-600 px-2 py-1 rounded transition duration-150">
                                                    <i class="fas fa-eye"></i>
                                                </a>
                                                <a href="{{ route('contacts.edit', $contact->id) }}" class="text-yellow-600 hover:text-white hover:bg-yellow-500 px-2 py-1 rounded transition duration-150">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <button onclick="confirmDelete({{ $contact->id }}, '{{ addslashes($contact->name) }}')" class="text-red-600 hover:text-white hover:bg-red-600 px-2 py-1 rounded transition duration-150">
